...
class ProcessPensionServiceImplTest {
	...
	@Test
	void testCalculatePensionAmountIsSelfPension() throws InvalidPensionerDetails {
	...
	@Test
	void testCalculatePensionAmountIsFamilyPension() throws InvalidPensionerDetails {
		Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
		Date dob = myCalendar.getTime();
	...
	@Test
	void testGetPensionDetail() throws InvalidPensionerDetails, InvalidTokenException {
...
//	}
	...
	@Test
	void testGetPensionDetailValidInput() throws InvalidPensionerDetails {
		String token = "dummyToken";
		Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
		Date dob = myCalendar.getTime();
	...
	@Test
	void testGetPensionDetailInValidInput() throws InvalidPensionerDetails, InvalidTokenException {
		String token = "dummyToken";
...
//		}
		@Test
		void testGetPensionDetailInValidInputName() throws InvalidPensionerDetails, InvalidTokenException {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailValidInputName() throws InvalidPensionerDetails {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailInValidInputDob() throws InvalidPensionerDetails, InvalidTokenException {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailValidInputDob() throws InvalidPensionerDetails {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailInValidInputPan() throws InvalidPensionerDetails, InvalidTokenException {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailValidInputPan() throws InvalidPensionerDetails {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailInValidInputisSelf() throws InvalidPensionerDetails, InvalidTokenException {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "self", "Punjab National Bank", 010120120, "public");
		...
		@Test
		void testGetPensionDetailValidInputSelf() throws InvalidPensionerDetails {
			String token = "dummyToken";
			Calendar myCalendar = new GregorianCalendar(1998, 12, 8);
			Date dob = myCalendar.getTime();
			PensionerDetailPojo pensionerDetail = new PensionerDetailPojo(546789641236L, "om", dob, "LWDSW1141",18000.0, 1200.0, "family", "Punjab National Bank", 010120120, "public");
