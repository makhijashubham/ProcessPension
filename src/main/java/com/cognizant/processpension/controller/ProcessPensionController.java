...
public class ProcessPensionController {
	...
	public ResponseEntity<PensionDetail> getPensionDetail(@RequestBody PensionerInput pensionerInput,@RequestHeader(name="Authorization") String header) throws  InvalidTokenException, InvalidPensionerDetails
	{
